...
import FormPicker from "../components/MyFormPicker";
import { blue, dark, light, main, w400, w500 } from "../constants";
import MyButton from "../components/MyButton";
import FormSwitch from "../components/MySwitch";
...
const CoeffMethodScreen: FC = () => {
  ...
  const UkTab = [
    ...
    [
      // индекс нь ro-оор тодорхойлогдоно...
      [15, 19, 23, 26, 28, 30, 32, 34, 36, 39, 40, 42, 44, 46, 48, 50, 53],
      [10, 13, 16, 19, 20, 22, 24, 25, 27, 29, 31, 33, 34, 36, 38, 40, 44],
      [4, 6, 9, 10, 11, 12, 13, 14, 16, 17, 18, 19, 20, 22, 24, 25, 28],
    ], // Улайсах...
    [
  ...
  const loadOptions = [
    ...
    [
      { label: "25 Вт", value: "220" },
      { label: "40 Вт", value: "400" },
      { label: "60 Вт", value: "735" },
      { label: "100 Вт", value: "1400" },
      { label: "150 Вт", value: "2000" },
      { label: "200 Вт", value: "3300" },
      { label: "300 Вт", value: "4600" },
      { label: "500 Вт", value: "8300" },
      { label: "1000 Вт", value: "18600" },
    ],
    [
  ...
  const numberLightOptions = [
    ...
    [
      ...
      { label: "Гурван гэрлийн шилтэй", value: 3 },
      { label: "Дөрвөн гэрлийн шилтэй", value: 4 },
      { label: "Таван гэрлийн шилтэй", value: 5 },
      { label: "Зургаан гэрлийн шилтэй", value: 6 },
      { label: "Долоон гэрлийн шилтэй", value: 7 },
      { label: "Найман гэрлийн шилтэй", value: 8 },
      { label: "Есөн гэрлийн шилтэй", value: 9 },
      { label: "Арван гэрлийн шилтэй", value: 10 },
    ],
  ];
  ...
  const publicCalc = (length: number, width: number, area: number) => {
    if (calcContext) {
      ...
      if (i <= 0.5) {
        ...
        else if (lightType === "1" && ro === "0") Uk = 15;
        else if (lightType === "1" && ro === "1") Uk = 10;
        else if (lightType === "1" && ro === "2") Uk = 4;
        else if (lightType === "2" && ro === "0") Uk = 33;
        else if (lightType === "2" && ro === "1") Uk = 32;
        else if (lightType === "2" && ro === "2") Uk = 25;
        else if (lightType === "2" && ro === "3") Uk = 30;
      } else if (i >= 5) {
        if (lightType === "0" && ro === "0") Uk = 59;
        else if (lightType === "0" && ro === "1") Uk = 53;
        else if (lightType === "0" && ro === "2") Uk = 43;
        else if (lightType === "1" && ro === "0") Uk = 53;
        else if (lightType === "1" && ro === "1") Uk = 44;
        else if (lightType === "1" && ro === "2") Uk = 28;
        else if (lightType === "2" && ro === "0") Uk = 83;
        else if (lightType === "2" && ro === "1") Uk = 78;
        else if (lightType === "2" && ro === "2") Uk = 74;
        else if (lightType === "2" && ro === "3") Uk = 71;
      } else {
  ...
  return (
    <ScrollView style={css.container}>
      ...
      >
        ...
        >
          Шаардагдах гэрэлтэлт :{" "}
          {normalLuminosity[parseInt(buildingType)][parseInt(roomType)]} Лк
        </Text>
        <Text style={css.subtitle}>Хариу : </Text>
        <Text
          style={{
            fontFamily: w400,
            color: blue,
        ...
        >
          {numberLight} ш {type} чийдэнтэй тус бүр нь {privateLuminosity} Лм
          тооцооны гэрлийн урсгалтай гэрлийн шилтэй гэрэлтүүлэгч нийт : {result}{" "}
          ш{" "}
        </Text>
      </ResultModal>
      <FormPicker
      ...
      {lightType === "0" || lightType === "1" ? (
        <FormPicker
          ...
          icon="alpha-n"
          options={numberLightOptions[lightType]}
      ...
      {chadlaar ? (
        ...
        <Textfield
          label="Хувийн тооцооны гэрлийн урсгал, Лм"
